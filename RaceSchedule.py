...
try:
    ...
    print(table) #This displays the schedule for the required season.
...
race = input('Enter race name:') #Enter the word(s) before 'Grand Prix' as seen from the table displayed
race = race + ' Grand Prix'
event = input('Enter event (Race or Qualifying):')
baseurl1 = 'http://ergast.com/api/f1/'
